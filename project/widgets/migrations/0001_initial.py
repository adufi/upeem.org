    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('', 'Aucun'), ('DIR.ANIM.', 'Directrice Animation')], max_length=120)),
                ('grades', models.CharField(blank=True, default='', max_length=120, verbose_name='BAFA/BPJEPS')),
                ('qualifications', models.CharField(blank=True, default='', max_length=120, verbose_name='PSC1/BTS')),
            ],
        ),
        migrations.CreateModel(
            name='Place',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_start', models.CharField(blank=True, default='', max_length=120, verbose_name='Début')),
                ('program_end', models.CharField(blank=True, default='', max_length=120, verbose_name='Date')),
